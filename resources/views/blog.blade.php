    ...
    <div class="min-h-full">
        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class= "container">
                <div class="list-blog">
                    <div class="blog">
                        <img src="img/ElainaViolent.jpg" alt="" class="img-blog">
                        <div class="blog-content">
                            <h3 class="tittle-blog">Tutorial Bernafas</h3>
                            <p class="desc-blog">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione, tempora?</p>
                        </div>
                    </div>
                    <div class="blog">
                        <img src="img/ElainaViolent.jpg" alt="" class="img-blog">
                        <div class="blog-content">
                            <h3 class="tittle-blog">Tutorial Makan</h3>
                            <p class="desc-blog">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione, tempora?</p>
                        </div>
                    </div>
                </div>
